...
/*
 * Uses shared memory to load grid nodes into shared memory.
 * Particles then iteratively accumulate grid node values.
 * TODO: Rework to assign threads to particles.
 */
