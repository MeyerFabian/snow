...
void Vector4i::print() const{
    std::cout<<"Vector4i=   " << this->x << " "<< this->y << " "<< this->z << " " <<this->w << std::endl;
}
...
void Matrix4f::print() const {
    std::cout<<"Matrix4f=   " << this->m[0][0] << " "<< this->m[1][0] << " "<<this->m[2][0]  << " "<<this->m[3][0]  << std::endl;
    std::cout<<"            " << this->m[0][1] << " "<< this->m[1][1] << " "<<this->m[2][1]   << " "<<this->m[3][1]  << std::endl;
    std::cout<<"            " <<this->m[0][2]  << " "<< this->m[1][2]<< " "<< this->m[2][2] << " "<<this->m[3][2]  << std::endl;
    std::cout<<"            " << this->m[0][3] << " "<< this->m[1][3] << " "<<  this->m[2][3]<< " "<< this->m[3][3] << std::endl;
}
