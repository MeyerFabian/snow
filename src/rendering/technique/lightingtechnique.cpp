...
void LightingTechnique::setLight(Vector3f LightPosition, float ambient, Vector3f Color, float diffuse){
    glUniform3f(gLightLocation,LightPosition.x,LightPosition.y,LightPosition.z);
