...
void ParticleCompute::setGridPos(const float gridPosx, const float gridPosy,
...
void ParticleCompute::setYoung() { glUniform1f(young, YOUNG_MODULUS); }

void ParticleCompute::setPoisson() { glUniform1f(poisson, POISSON); }

void ParticleCompute::setHardening() { glUniform1f(hardening, HARDENING); }
