...
void Vector3f::print() const {
  std::cout << "Vector3f=   " << this->x << " " << this->y << " " << this->z
            << std::endl;
}

void Vector4f::print() const {
  std::cout << "Vector4f=   " << this->x << " " << this->y << " " << this->z
            << " " << this->w << std::endl;
}
Vector3f Vector4f::xyz() { return Vector3f(this->x, this->y, this->z); }

void Vector3i::print() const {
  std::cout << "Vector3i=   " << this->x << " " << this->y << " " << this->z
            << std::endl;
}

void Vector4i::print() const {
  std::cout << "Vector4i=   " << this->x << " " << this->y << " " << this->z
            << " " << this->w << std::endl;
}
...
void Matrix3f::print() const {
  std::cout << "Matrix3f=   " << this->m[0][0] << " " << this->m[0][1] << " "
            << this->m[0][2] << std::endl;
...
void Matrix4d::print() const {
  std::cout << "Matrix4d=   " << this->m[0][0] << " " << this->m[0][1] << " "
...
void Matrix4f::LoadRotation(Vector3f& rotation) {
  ...
  this->m[0][3] = 0.0f;
  this->m[1][0] = 0.0f;
  this->m[1][1] = cosf(rotation.x);
  this->m[1][2] = -sinf(rotation.x);
  this->m[1][3] = 0.0f;
  this->m[2][0] = 0.0f;
  this->m[2][1] = sinf(rotation.x);
  this->m[2][2] = cosf(rotation.x);
  this->m[2][3] = 0.0f;
  this->m[3][0] = 0.0f;
  this->m[3][1] = 0.0f;
  this->m[3][2] = 0.0f;
  ...
  Matrix4f r1;
  r1.m[0][0] = cosf(rotation.y);
  r1.m[0][1] = 0.0f;
  r1.m[0][2] = sinf(rotation.y);
  r1.m[0][3] = 0.0f;
  r1.m[1][0] = 0.0f;
  r1.m[1][1] = 1.0f;
  r1.m[1][2] = 0.0f;
  r1.m[1][3] = 0.0f;
  r1.m[2][0] = -sinf(rotation.y);
  r1.m[2][1] = 0.0f;
  r1.m[2][2] = cosf(rotation.y);
  r1.m[2][3] = 0.0f;
  r1.m[3][0] = 0.0f;
  r1.m[3][1] = 0.0f;
  r1.m[3][2] = 0.0f;
  ...
  r2.m[0][0] = cosf(rotation.z);
  r2.m[0][1] = -sinf(rotation.z);
  r2.m[0][2] = 0.0f;
  r2.m[0][3] = 0.0f;
  r2.m[1][0] = sinf(rotation.z);
  r2.m[1][1] = cosf(rotation.z);
  r2.m[1][2] = 0.0f;
  r2.m[1][3] = 0.0f;
  r2.m[2][0] = 0.0f;
  r2.m[2][1] = 0.0f;
...
void Matrix4f::LoadPosition(Vector3f& position) {
  ...
  this->m[0][1] = 0.0f;
  this->m[0][2] = 0.0f;
  this->m[0][3] = position.x;
  this->m[1][0] = 0.0f;
  this->m[1][1] = 1.0f;
  this->m[1][2] = 0.0f;
  this->m[1][3] = position.y;
  this->m[2][0] = 0.0f;
  this->m[2][1] = 0.0f;
  this->m[2][2] = 1.0f;
  this->m[2][3] = position.z;
  this->m[3][0] = 0.0f;
  this->m[3][1] = 0.0f;
  this->m[3][2] = 0.0f;
  this->m[3][3] = 1.0f;
...
void Matrix4f::LoadPerspMatrix(persp_info& m_persp) {
  ...
  this->m[0][0] = 1.0f / (tangens * ar);
  this->m[0][1] = 0.0f;
  this->m[0][2] = 0.0f;
  this->m[0][3] = 0.0f;
  this->m[1][0] = 0.0f;
  this->m[1][1] = 1.0f / (tangens);
  this->m[1][2] = 0.0f;
  this->m[1][3] = 0.0f;
  this->m[2][0] = 0.0f;
  this->m[2][1] = 0.0f;
  this->m[2][2] = ((-zNear - zFar) / zdif);
  this->m[2][3] = 2.0f * zFar * zNear / (zdif);
  this->m[3][0] = 0.0f;
  this->m[3][1] = 0.0f;
  this->m[3][2] = 1.0f;
  this->m[3][3] = 0.0f;
...
void Matrix4f::LoadCameraMatrix(Vector3f& xAxis, Vector3f& yAxis,
                                Vector3f& zAxis) {
  this->m[0][0] = xAxis.x;
  this->m[0][1] = xAxis.y;
  this->m[0][2] = xAxis.z;
